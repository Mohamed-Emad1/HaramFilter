...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "onboardingTitle": MessageLookupByLibrary.simpleMessage("الكشف الذكي"),
    "onboarding_Second_Subtitle": MessageLookupByLibrary.simpleMessage(
      "قم بتشغيل نموذج Haram Filter بلمسة واحدة — واحصل على نتيجة فورية توضح إن كان المحتوى آمنًا أو يحتاج مراجعة.",
    ),
    "onboarding_Second_Title": MessageLookupByLibrary.simpleMessage(
      "تصفية بالذكاء الاصطناعي في الوقت الحقيقي",
    ),
    "onboarding_Third_Subtitle": MessageLookupByLibrary.simpleMessage(
      "تتم جميع المعالجات على الجهاز لضمان بقاء بياناتك خاصة وآمنة.",
    ),
